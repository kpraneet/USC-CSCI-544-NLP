...
def main():
    ...
    spamunknownprobability = float(1 / (spamcount + totaluniquecount))
    hamunknownprobability = float(1 / (hamcount + totaluniquecount))
    probabilityspam = float(spamfilecount / filecount)
    probabilityham = float(hamfilecount / filecount)
    f = open("nbmodel-task3.txt", "a")
    f.truncate(0)
    ...
    f.write('\n')
    f.write(str(spamunknownprobability))
    f.write('\n')
    f.write(str(hamunknownprobability))
    f.write('\n')
    f.close()
    # print(spam)
    # print(ham)
